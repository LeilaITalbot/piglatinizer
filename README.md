...
## Day 1
### Planning
- [o] Review your Starter Code and make sure you understand what code has already been written for you.
### Set-Up
- [o] Go to the repository at https://github.com/itscodenation/piglatinizer
- [o] Fork this repository to your github account and pull it into Gitpod
- [ ] Add, commit, and push your changes
- [ ] Make your site live on gh-pages
### index.html
- [ ] Make small updates.
### JS
- [o] Create a click handler to take user input and display it on the page
